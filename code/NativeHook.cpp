...
namespace Sentinel
{
	auto ALL_SCRIPT_HASH = RAGE_JOAAT("ALL_SCRIPTS");

	NativeHooks::NativeHooks()
	{
		AddNativeDetour("SGI", RAGE_JOAAT("main_persistent"), 0x767FBC2AC802EF3D, Hooks::StatGetInt);
